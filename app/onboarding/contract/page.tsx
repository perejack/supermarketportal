          ...
          <div className="space-y-3 p-6 text-sm">
            ...
            <div className="rounded-xl border-2 p-4" style={{ borderColor: b.primary }}>
              ...
              <div className="mt-2 grid gap-1 text-xs">
                ...
                <Row k="Branch" v={`${b.logoText} — ${user.branch}`} />
              </div>
            </div>
          ...
          >
            <div className="relative flex items-center gap-4">
              ...
              <div className="min-w-0">
                <div className="font-display text-xl font-bold sm:text-2xl">{!paid ? "Locked · Pay first" : !user.branch ? "Pick branch first (Dashboard)" : "Download Contract PDF"}</div>
                <div className="truncate text-sm opacity-90">
                  {user.fullName} · {b.logoText}
